(function (global, factory) {
  ...
  (global = global || self, factory(global.ChartGeo = {}, global.ChartESMFacade));
  ...
  var GeoFeature = /*#__PURE__*/function (_Element) {
    inherits(GeoFeature, _Element);

    var _super = _createSuper(GeoFeature);

    function GeoFeature() {
      classCallCheck(this, GeoFeature);

      return _super.apply(this, arguments);
    }

    createClass(GeoFeature, [{
      key: "inRange",
      value: function inRange(mouseX, mouseY) {
        ...
        var projection = this.projectionScale.geoPath.projection();
      ...
      value: function getCenterPoint() {
        ...
        var centroid = this.projectionScale.geoPath.centroid(this.feature);
        var center = {
          x: centroid[0],
          y: centroid[1]
        };
      ...
      value: function getBounds() {
        ...
        var bb = this.projectionScale.geoPath.bounds(this.feature);
        var bounds = {
          x: bb[0][0],
          x2: bb[1][0],
          y: bb[0][1],
      ...
      key: "_drawInCache",
      value: function _drawInCache(doc) {
    ...
    return GeoFeature;
  }(chartjsEsmFacade.Element);
  GeoFeature.id = 'geoFeature';
  GeoFeature.defaults = /*#__PURE__*/Object.assign({}, chartjsEsmFacade.Rectangle.defaults, {
  ...
  }, chartjsEsmFacade.Rectangle.defaultRoutes || {});
  ...
  var ProjectionScale = /*#__PURE__*/function (_Scale) {
    inherits(ProjectionScale, _Scale);

    var _super = _createSuper$1(ProjectionScale);

    function ProjectionScale(cfg) {
      var _this;

      classCallCheck(this, ProjectionScale);

      _this = _super.call(this, cfg);
      _this.geoPath = geoPath();
      return _this;
    }

    createClass(ProjectionScale, [{
      key: "init",
      value: function init(options) {
        options.position = 'chartArea';

        get(getPrototypeOf(ProjectionScale.prototype), "init", this).call(this, options);
      ...
      key: "computeBounds",
      value: function computeBounds(outline) {
    ...
    return /*#__PURE__*/function (_superClass) {
      ...
      createClass(_class, [{
        ...
        value: function init(options) {
          ...
          get(getPrototypeOf(_class.prototype), "init", this).call(this, options);
        ...
        value: function parse(raw, index) {
          ...
          return get(getPrototypeOf(_class.prototype), "parse", this).call(this, raw, index);
        }
      }, {
        key: "isHorizontal",
        ...
        value: function _getNormalizedValue(v) {
        ...
        key: "_getLegendMargin",
        value: function _getLegendMargin() {
          var indicatorWidth = this.options.legend.indicatorWidth;
          var pos = this.options.legend.align;
        ...
        key: "_getLegendPosition",
        value: function _getLegendPosition(chartArea) {
          var indicatorWidth = this.options.legend.indicatorWidth;
          var axisPos = this.options.legend.align;
        ...
        value: function update(maxWidth, maxHeight, margins) {
          var ch = Math.min(maxHeight, this.bottom == null ? Number.POSITIVE_INFINITY : this.bottom);
          var cw = Math.min(maxWidth, this.right == null ? Number.POSITIVE_INFINITY : this.right);
          ...
          var bak = this.options.position;
          this.options.position = this.options.legend.align;

          get(getPrototypeOf(_class.prototype), "update", this).call(this, w, h, margins);
        ...
        value: function draw(chartArea) {
          ...
          get(getPrototypeOf(_class.prototype), "draw", this).call(this, Object.assign({}, chartArea, {
            bottom: this.height,
            right: this.width
          }));
  ...
  function ColorScaleMixin(superClass) {
    return /*#__PURE__*/function (_BaseMixin) {
      inherits(_class, _BaseMixin);
      ...
      createClass(_class, [{
        ...
        key: "getColor",
        value: function getColor(normalized) {
          var v = normalized;
        ...
        key: "_drawIndicator",
        value: function _drawIndicator() {
          /** @type {CanvasRenderingContext2D} */
          var ctx = this.ctx;
          var w = this.width;
          var h = this.height;
          var indicatorSize = this.options.legend.indicatorWidth;
          var reverse = this._reversePixels;
      ...
      return _class;
    }(BaseMixin(superClass));
  }

  var ColorScale = /*#__PURE__*/function (_ColorScaleMixin) {
    inherits(ColorScale, _ColorScaleMixin);

    var _super2 = _createSuper$3(ColorScale);
    ...
    return ColorScale;
  }(ColorScaleMixin(chartjsEsmFacade.LinearScale));
  ...
  ColorScale.id = 'color';
  ColorScale.defaults = /*#__PURE__*/chartjsEsmFacade.merge({}, [chartjsEsmFacade.LinearScale.defaults, baseDefaults, colorScaleDefaults]);
  var ColorLogarithmicScale = /*#__PURE__*/function (_ColorScaleMixin2) {
    inherits(ColorLogarithmicScale, _ColorScaleMixin2);

    var _super3 = _createSuper$3(ColorLogarithmicScale);

    function ColorLogarithmicScale() {
      classCallCheck(this, ColorLogarithmicScale);

      return _super3.apply(this, arguments);
    }

    createClass(ColorLogarithmicScale, [{
      key: "_getNormalizedValue",
      value: function _getNormalizedValue(v) {
        if (v == null || Number.isNaN(v)) {
          return null;
  ...
  }(ColorScaleMixin(chartjsEsmFacade.LogarithmicScale));
  ColorLogarithmicScale.id = 'colorLogarithmic';
  ColorLogarithmicScale.defaults = /*#__PURE__*/chartjsEsmFacade.merge({}, [chartjsEsmFacade.LogarithmicScale.defaults, baseDefaults, colorScaleDefaults]);
  ...
  function SizeSaleMixin(superClass) {
    return /*#__PURE__*/function (_BaseMixin) {
      ...
      var _super = _createSuper$4(_class);
      ...
      createClass(_class, [{
        key: "getSizeForValue",
        value: function getSizeForValue(value) {
          var v = this._getNormalizedValue(value);
        ...
        key: "getSizeImpl",
        value: function getSizeImpl(normalized) {
          var _this$options$range = slicedToArray(this.options.range, 2),
        ...
        value: function _drawIndicator() {
          ...
          var isHor = this.isHorizontal();
          var values = this.ticks;
          var positions = this._labelItems || values.map(function (_, i) {
            return defineProperty({}, isHor ? 'x' : 'y', _this.getPixelForTick(i));
          });
          (this._gridLineItems || []).forEach(function (item) {
            ...
            if (_this.options.gridLines.drawTicks) {
              switch (_this.options.legend.align) {
                case 'left':
          ...
          if (this._model) {
            var props = this._model;
            ctx.strokeStyle = props.borderColor || chartjsEsmFacade.defaults.color;
            ctx.lineWidth = props.borderWidth || 0;
            ctx.fillStyle = props.backgroundColor || chartjsEsmFacade.defaults.color;
          } else {
            ctx.fillStyle = 'blue';
          }
          ...
          values.forEach(function (v, i) {
            ...
            var radius = _this.getSizeForValue(v.value);

            var x = isHor ? pos.x : shift;
            var y = isHor ? shift : pos.y;
            var renderOptions = Object.assign({}, _this._model || {}, {
              radius: radius
            });
            chartjsEsmFacade.drawPoint(ctx, renderOptions, x, y);
          });
        }
      }]);
  ...
  var SizeScale = /*#__PURE__*/function (_SizeSaleMixin) {
    inherits(SizeScale, _SizeSaleMixin);

    var _super2 = _createSuper$4(SizeScale);

    function SizeScale() {
      classCallCheck(this, SizeScale);

      return _super2.apply(this, arguments);
    }

    return SizeScale;
  }(SizeSaleMixin(chartjsEsmFacade.LinearScale));
  var scaleDefaults = {
    missing: 1,
    mode: 'area',
    // 'radius'
  ...
  SizeScale.id = 'size';
  SizeScale.defaults = /*#__PURE__*/chartjsEsmFacade.merge({}, [chartjsEsmFacade.LinearScale.defaults, baseDefaults, scaleDefaults]);
  var SizeLogarithmicScale = /*#__PURE__*/function (_SizeSaleMixin2) {
    inherits(SizeLogarithmicScale, _SizeSaleMixin2);

    var _super3 = _createSuper$4(SizeLogarithmicScale);

    function SizeLogarithmicScale() {
      classCallCheck(this, SizeLogarithmicScale);

      return _super3.apply(this, arguments);
    }

    createClass(SizeLogarithmicScale, [{
      key: "_getNormalizedValue",
      value: function _getNormalizedValue(v) {
        if (v == null || Number.isNaN(v)) {
          return null;
  ...
  }(SizeSaleMixin(chartjsEsmFacade.LogarithmicScale));
  SizeLogarithmicScale.id = 'sizeLogarithmic';
  SizeLogarithmicScale.defaults = /*#__PURE__*/chartjsEsmFacade.merge({}, [chartjsEsmFacade.LogarithmicScale.defaults, baseDefaults, scaleDefaults]);
  ...
  var geoDefaults = {
    datasetElementOptions: ['outlineBackgroundColor', 'outlineBorderColor', 'outlineBorderWidth', 'graticuleBorderColor', 'graticuleBorderWidth'],
    showOutline: false,
    showGraticule: false,
    clipMap: true,
    scales: {
  ...
  function patchDatasetElementOptions(options) {
    ...
    Object.keys(options).forEach(function (key) {
      ...
      if (key.startsWith('outline')) {
        var sub = key.slice('outline'.length);
  ...
  var GeoController = /*#__PURE__*/function (_DatasetController) {
    inherits(GeoController, _DatasetController);

    var _super = _createSuper$5(GeoController);

    function GeoController() {
      classCallCheck(this, GeoController);

      return _super.apply(this, arguments);
    }

    createClass(GeoController, [{
      key: "getProjectionScale",
      value: function getProjectionScale() {
      ...
      value: function showOutline() {
        return chartjsEsmFacade.valueOrDefault(this.getDataset().showOutline, this.chart.options.showOutline);
      }
    }, {
      key: "clipMap",
      value: function clipMap() {
        return chartjsEsmFacade.valueOrDefault(this.getDataset().clipMap, this.chart.options.clipMap);
      }
    }, {
      key: "getGraticule",
      value: function getGraticule() {
        return chartjsEsmFacade.valueOrDefault(this.getDataset().showGraticule, this.chart.options.showGraticule);
      }
    }, {
      key: "update",
      value: function update(mode) {
        get(getPrototypeOf(GeoController.prototype), "update", this).call(this, mode);

        var active = mode === 'active';
        var meta = this.getMeta();
        var scale = this.getProjectionScale();
        var dirtyCache = scale.updateBounds();

        if (this.showOutline()) {
          var elem = meta.dataset;
        ...
        if (dirtyCache) {
          meta.data.forEach(function (elem) {
            return delete elem.cache;
          });
        }
      }
    }, {
      key: "resolveOutline",
      value: function resolveOutline() {
      ...
      value: function showGraticule() {
        ...
        var scale = this.getProjectionScale();
        var path = scale.geoPath.context(ctx);
        ctx.save();
        ctx.beginPath();
        ...
        var options = this.getMeta().graticule;
      ...
      value: function draw() {
        ...
        if (clipMap === true || clipMap === 'outline' || clipMap === 'outline+graticule') {
          enabled = true;
          chartjsEsmFacade.clipArea(chart.ctx, chart.chartArea);
        }
        ...
        if (clipMap === true || clipMap === 'graticule' || clipMap === 'outline+graticule') {
          ...
          enabled = false;
          chartjsEsmFacade.unclipArea(chart.ctx);
        }
  ...
  }(chartjsEsmFacade.DatasetController);
  ...
  var ChoroplethController = /*#__PURE__*/function (_GeoController) {
    inherits(ChoroplethController, _GeoController);

    var _super = _createSuper$6(ChoroplethController);

    function ChoroplethController() {
      classCallCheck(this, ChoroplethController);

      return _super.apply(this, arguments);
    }

    createClass(ChoroplethController, [{
      key: "linkScales",
      value: function linkScales() {
        get(getPrototypeOf(ChoroplethController.prototype), "linkScales", this).call(this);
      ...
      value: function parse(start, count) {
        var rScale = this.getMeta().rScale;
        var data = this.getDataset().data;
        var meta = this._cachedMeta;

        for (var i = start; i < start + count; ++i) {
          meta._parsed[i] = defineProperty({}, rScale.axis, rScale.parse(data[i]));
        }
      }
    }, {
      key: "updateElements",
      value: function updateElements(elems, start, mode) {
        ...
        var sharedOptions = this.getSharedOptions(mode, elems[start], firstOpts);
      ...
      key: "indexToColor",
      value: function indexToColor(index) {
        var rScale = this.getMeta().rScale;
  ...
  ChoroplethController.defaults = /*#__PURE__*/chartjsEsmFacade.merge({}, [geoDefaults, {
    ...
    tooltips: {
      callbacks: {
        ...
        label: function label(item) {
          ...
          return "".concat(item.chart.data.labels[item.dataIndex], ": ").concat(item.formattedValue);
        }
      }
    },
    scales: {
  ...
  var ChoroplethChart = /*#__PURE__*/function (_Chart) {
    inherits(ChoroplethChart, _Chart);

    var _super2 = _createSuper$6(ChoroplethChart);

    function ChoroplethChart(item, config) {
      classCallCheck(this, ChoroplethChart);

      return _super2.call(this, item, patchController(config, ChoroplethController, GeoFeature, [ColorScale, ProjectionScale]));
    }
  ...
  var BubbleMapController = /*#__PURE__*/function (_GeoController) {
    inherits(BubbleMapController, _GeoController);

    var _super = _createSuper$7(BubbleMapController);

    function BubbleMapController() {
      classCallCheck(this, BubbleMapController);

      return _super.apply(this, arguments);
    }

    createClass(BubbleMapController, [{
      key: "linkScales",
      value: function linkScales() {
        get(getPrototypeOf(BubbleMapController.prototype), "linkScales", this).call(this);
      ...
      value: function updateElements(elems, start, mode) {
        ...
        for (var i = 0; i < elems.length; i++) {
          ...
          var xy = scale.projection([parsed.x, parsed.y]);
          var properties = {
            x: xy ? xy[0] : 0,
            y: xy ? xy[1] : 0,
      ...
      key: "indexToRadius",
      value: function indexToRadius(index) {
        var rScale = this.getMeta().rScale;
  ...
  BubbleMapController.defaults = chartjsEsmFacade.merge({}, [geoDefaults, {
    dataElementType: chartjsEsmFacade.Point.id,
    dataElementOptions: chartjsEsmFacade.BubbleController.defaults.dataElementOptions,
    datasetElementType: GeoFeature.id,
    showOutline: true,
  ...
  var BubbleMapChart = /*#__PURE__*/function (_Chart) {
    inherits(BubbleMapChart, _Chart);

    var _super2 = _createSuper$7(BubbleMapChart);

    function BubbleMapChart(item, config) {
      classCallCheck(this, BubbleMapChart);

      return _super2.call(this, item, patchController(config, BubbleMapController, GeoFeature, [SizeScale, ProjectionScale]));
    }
  ...
  chartjsEsmFacade.registry.addControllers(ChoroplethController, BubbleMapController);
  chartjsEsmFacade.registry.addScales(ColorLogarithmicScale, SizeLogarithmicScale, ProjectionScale, ColorScale, SizeScale);
  chartjsEsmFacade.registry.addElements(GeoFeature);
