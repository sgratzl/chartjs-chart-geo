...
Chart.scaleService.registerScaleType('color', ColorScale, Chart.helpers.merge({}, [Chart.scaleService.getScaleDefaults('linear'), baseDefaults, defaults]));
Chart.scaleService.registerScaleType('colorLogarithmic', ColorScaleLogarithmic, Chart.helpers.merge({}, [Chart.scaleService.getScaleDefaults('logarithmic'), baseDefaults, defaults]));
